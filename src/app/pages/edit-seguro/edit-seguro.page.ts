...
@Component({
  ...
  templateUrl: './edit-seguro.page.html',
  styleUrls: ['./edit-seguro.page.scss'],
})
export class EditSeguroPage implements OnInit {
  ...
  editSeguro(compania: any, poliza: any) {
    ...
    this.dataService.updateSeguro(this.token, this.id_user, compania, poliza)
      .subscribe( (data2: any) => {
